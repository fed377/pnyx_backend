...
const mind: Grid = {
  ...
  points: [
    { x: 0, y: 0, name: "Grey", hex: "#6B6862", meaning: "Weighs feeling and evidence in equal measure" },
    { x: 0.33, y: 0.33, name: "Orange", hex: "#FF924C", meaning: "Trusts instinct, then tests it on something real" },
    { x: 0.66, y: 0.66, name: "Yellow", hex: "#FFCA3A", meaning: "Reads the room faster than the report" },
    { x: 1, y: 1, name: "Green", hex: "#8AC926", meaning: "Decides on feel and builds it the same day" },
    { x: 0.33, y: -0.33, name: "Teal", hex: "#2EC4B6", meaning: "Wants the method, but only if it ships" },
    { x: 0.66, y: -0.66, name: "Blue", hex: "#1982C4", meaning: "Measures first, argues later" },
    { x: 1, y: -1, name: "Indigo", hex: "#4267E8", meaning: "Evidence, applied — nothing decorative" },
    { x: -0.33, y: -0.33, name: "Purple", hex: "#7B2CBF", meaning: "Prefers the underlying rule to the worked example" },
    { x: -0.66, y: -0.66, name: "Violet", hex: "#C77DFF", meaning: "Happiest one abstraction above the problem" },
    { x: -1, y: -1, name: "Pink", hex: "#FF70A6", meaning: "Truth first, usefulness whenever" },
    { x: -0.33, y: 0.33, name: "Purple-pink", hex: "#9B5DE5", meaning: "Thinks in images and meanings" },
    { x: -0.66, y: 0.66, name: "Bright cyan", hex: "#00BBF9", meaning: "Builds whole worlds before touching one" },
    { x: -1, y: 1, name: "Magenta", hex: "#F15BB5", meaning: "The feeling is the argument" },
  ],
};
